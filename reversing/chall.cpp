...
int main() {
    ...
    while(1) {
        ...
        // tmp++;
        //printf("Test %d\n",tmp);
        if (48 < local_11c) break;
        local_118[(int)local_11c] =
            (unsigned char)local_11c ^
            *(unsigned char *)((long)&local_98 + (long)(int)local_11c) ^
            *(unsigned char *)((long)&local_58 + (long)(int)local_11c) ^ 0x13;
